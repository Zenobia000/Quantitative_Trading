...
from backtest_platform.strategies.protocol import describe_strategy, get_strategy
...
def evaluate_branch(
    ...
    *,
    ...
    """
    from backtest_platform.research.evaluation.orchestrator import evaluate as _default_evaluate
    from backtest_platform.research.evaluation.report_pack import DEFAULT_PACK_ROOT
