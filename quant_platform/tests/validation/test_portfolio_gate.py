...
from quant_platform.services.research_validation.validation.portfolio_gate import (
    apply_stop_outs,
    combine_returns,
    portfolio_gate_report,
    sleeve_weights,
)
from quant_platform.services.research_validation.validation.two_stage_gate import SizingConfig, SizingInput
...
def test_deflated_sharpe_from_returns_matches_truth_gate_oracle() -> None:
    ...
    from quant_platform.services.research_validation.workflows.truth_gate import _deflated_sharpe
