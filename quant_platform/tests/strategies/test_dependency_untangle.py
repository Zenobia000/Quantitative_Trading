...
2. ``import quant_platform.services.research_validation.strategies`` is the single registration seam — after
...
def test_research_config_import_does_not_pull_zipline() -> None:
    ...
    code = (
        "import sys\n"
        "import quant_platform.services.research_validation.strategies.inst_flow.research_config  # noqa: F401\n"
...
def test_importing_strategies_package_registers_all_builtins() -> None:
    """``import quant_platform.services.research_validation.strategies`` populates the strategy registry."""
    import quant_platform.services.research_validation.strategies  # noqa: F401 — the registration seam
...
def test_inst_flow_n_trials_matches_grid_cardinality() -> None:
    ...
    from quant_platform.services.research_validation.strategies.inst_flow import research_config as rc
