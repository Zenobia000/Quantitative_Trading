...
from quant_platform.services.research_validation.workflows.universe import (
    UniverseBuildResult,
    run_build_universe,
)
...
def test_run_build_universe_excludes_flagged_when_opted_in(tmp_path):
    ...
    from quant_platform.services.research_validation.workflows.universe import _ELIGIBILITY_KEYS
...
def test_run_build_universe_surfaces_ingest_failures(tmp_path, monkeypatch):
    ...
    """
    import quant_platform.services.research_validation.workflows.universe as uni_mod
    from quant_platform.services.data_platform.finlab_source import FinlabIngestResult
