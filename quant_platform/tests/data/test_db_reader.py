...
from quant_platform.services.data_platform.db_reader import (
    BrokerState,
    PositionState,
    load_broker_state,
...
def test_open_positions_folds_fills_into_position_rows() -> None:
    ...
    with patch("quant_platform.services.monitoring_ops.telemetry_reader._connection") as ctx:
...
def test_load_broker_state_real_db() -> None:
    ...
    from quant_platform.services.monitoring_ops import telemetry_writer as dbw
