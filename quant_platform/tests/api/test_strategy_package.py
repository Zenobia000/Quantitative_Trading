...
def test_strategy_asset_projects_package_descriptor(client):
    ...
    assert data["package"] == "quant_platform.services.research_validation.strategies.momentum"
    assert data["package_path"].endswith("src/quant_platform/services/research_validation/strategies/momentum")
