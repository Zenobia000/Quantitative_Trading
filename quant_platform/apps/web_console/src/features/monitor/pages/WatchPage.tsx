  ...
  return (
    <section className="border border-border bg-surface">
      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-border px-3 py-2">
        <h2 className="font-mono text-[13px] font-semibold text-text">{row.strategy}</h2>
      ...
      <div className="grid grid-cols-1 gap-3 border-b border-border bg-surface px-3 py-2 sm:grid-cols-2">
        <div>
          ...
          <div className="h-1.5 w-full overflow-hidden bg-input" role="progressbar" aria-valuenow={pct}>
            <div className="h-full bg-gain/70" style={{ width: `${pct}%` }} />
          </div>
        </div>
      ...
      <div className="flex items-center gap-2 px-3 py-2">
        <button
          ...
          className="border border-border px-3 py-1.5 text-sm hover:bg-input hover:text-text disabled:opacity-50"
        >
...
function TimerHealthBlock({
  ...
  if (health === 'ok') {
    return (
      <div className="flex items-center gap-2 border-b border-gain/40 bg-surface px-3 py-2 text-sm">
  ...
  return (
    <div className="border-b border-error/40 bg-surface px-3 py-2 text-sm">
...
function CommandBlock({ cmd }: { cmd: string }) {
  ...
  return (
    <div className="mt-1 flex items-center gap-2 border border-border bg-input px-2 py-1">
      <code className="flex-1 overflow-x-auto font-mono text-xs text-text-secondary">{cmd}</code>
      <button
        onClick={copy}
        className="shrink-0 border border-border px-2 py-0.5 text-xs text-text-muted hover:bg-surface hover:text-text"
      >
