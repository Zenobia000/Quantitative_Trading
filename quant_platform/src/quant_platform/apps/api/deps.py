...
def get_data_root() -> Path:
    ...
    """
    from quant_platform.services.data_platform.bundle_registry import DEFAULT_DATA_ROOT
...
def get_telemetry_reader() -> Any:
    ...
    """
    from quant_platform.services.data_platform.db_reader import TelemetryReader
...
def get_candidates_path() -> Path:
    ...
    from quant_platform.packages.adapters.candidate_store import DEFAULT_CANDIDATES_PATH
...
def get_candidate_decisions_path() -> Path:
    ...
    from quant_platform.packages.adapters.candidate_store import DEFAULT_DECISIONS_PATH
...
def get_branches_path() -> Path:
    ...
    from quant_platform.packages.adapters.branch_store import DEFAULT_BRANCHES_PATH
...
def get_branch_evaluator() -> Any:
    ...
    """
    from quant_platform.packages.adapters.branch_store import evaluate_branch
