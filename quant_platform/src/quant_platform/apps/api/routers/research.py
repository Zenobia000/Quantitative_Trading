...
from quant_platform.apps.api.response_models import StrategyRow, UniverseFiltersData
...
def universe_filters() -> Envelope:
    ...
    """
    from quant_platform.services.data_platform.universe import UniverseConfig
