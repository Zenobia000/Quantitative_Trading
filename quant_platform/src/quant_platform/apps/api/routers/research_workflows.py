...
from quant_platform.services.monitoring_ops.jobs import submit
...
_WORKFLOWS: dict[str, tuple] = {
    "doe": (get_doe_config, "quant_platform.services.research_validation.workflows.doe:run_doe"),
    "go_gates": (get_go_gates_config, "quant_platform.services.research_validation.workflows.go_gates:run_go_gates"),
    "truth_gate": (get_truth_gate_config, "quant_platform.services.research_validation.workflows.truth_gate:run_truth_gate"),
    "paper_replay": (
        get_paper_replay_config,
        "quant_platform.services.research_validation.workflows.paper_replay:run_paper_replay_workflow",
    ),
    "build_universe": (
        get_universe_config,
        "quant_platform.services.research_validation.workflows.universe:run_build_universe",
    ),
}
