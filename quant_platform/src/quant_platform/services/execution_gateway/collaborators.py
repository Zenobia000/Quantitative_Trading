...
from quant_platform.services.execution_gateway.paper_broker import Fill, OrderSide, PaperBroker
from quant_platform.services.risk_gate.risk_gate import AccountState, Order, Position, RiskGate
...
def make_ingest(
    *,
    ...
    def ingest(symbols: list[str]) -> dict[str, bool]:
        if source == "finlab":
            from quant_platform.services.data_platform.finlab_source import ingest_universe_finlab
...
def make_db_sink(
    ...
    *,
    ...
    def sink(ctx: Any) -> str:
        from quant_platform.services.monitoring_ops import telemetry_writer as _dbw
