...
def cached_or_fetch(
    ...
    if fetch_fn is None:
        from quant_platform.services.data_platform.finmind_etl import fetch_bundle as fetch_fn
    ...
    from quant_platform.services.data_platform.finmind_etl import write_parquet
