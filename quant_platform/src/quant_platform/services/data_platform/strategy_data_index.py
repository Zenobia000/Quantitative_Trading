...
def default_strategies_root() -> Path:
    """The real strategies dir, in ``services/research_validation/strategies``.

    This module lives in ``services/data_platform``; strategies were carved into
    the research_validation service, hence the sibling-service hop.
    """
    return Path(__file__).resolve().parent.parent / "research_validation" / "strategies"
