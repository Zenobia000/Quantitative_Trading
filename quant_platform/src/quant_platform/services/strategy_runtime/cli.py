"""orchestration CLI — drive the daily pipeline (WBS 7.D.2).
    ...
    uv run python -m quant_platform.services.strategy_runtime.cli run --dry-run
    uv run python -m quant_platform.services.strategy_runtime.cli list-stages
...
from quant_platform.services.strategy_runtime.after_close import (
...
def watch_enroll_cmd(
    ...
    from quant_platform.services.governance_release.watch_registry import WatchRegistryError, enroll
...
def watch_status_cmd(strategy: str | None) -> None:
    ...
    from quant_platform.services.governance_release.watch_registry import (
...
def watch_resume_cmd(strategy: str) -> None:
    ...
    from quant_platform.services.governance_release.watch_registry import WatchRegistryError, resume
...
def live_oos_consume_cmd(date_str: str | None) -> None:
    ...
    from quant_platform.services.governance_release.live_oos_consumer import consume_queue
...
def live_oos_list_cmd(state: str | None) -> None:
    ...
    from quant_platform.services.governance_release.live_oos_queue import list_queue
