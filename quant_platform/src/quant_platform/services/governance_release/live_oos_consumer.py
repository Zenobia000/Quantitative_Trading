...
def default_run_paper_replay(strategy: str, as_of: date) -> Any:
    ...
    """
    from quant_platform.services.research_validation.workflows.config import PaperReplayConfig
...
def _berth_patch(st: Any) -> dict[str, Any]:
    ...
    from quant_platform.services.governance_release.watch_registry import OBSERVATION_DAYS
