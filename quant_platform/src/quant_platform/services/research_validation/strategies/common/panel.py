...
from quant_platform.services.research_validation.strategies.protocol import Loader
from quant_platform.services.research_validation.validation.metrics import cagr, max_drawdown, sharpe
