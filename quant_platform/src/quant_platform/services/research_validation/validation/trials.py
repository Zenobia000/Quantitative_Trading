...
guardrail on top of :mod:`quant_platform.services.research_validation.validation.dsr`:
...
def deflated_sharpe_pass(
    ...
    Computes :func:`~quant_platform.services.research_validation.validation.dsr.deflated_sharpe_ratio` and
