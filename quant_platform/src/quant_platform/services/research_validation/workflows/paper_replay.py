...
from quant_platform.services.research_validation.strategies.protocol import Loader, get_strategy, get_strategy_gate
from quant_platform.services.research_validation.validation.gate_state import evaluate_gate
