...
Expands one base spec x N stock groups into deterministic RunConfigs and runs
...
from quant_platform.packages.adapters.run_writer import mark_run_status, persist_run
...
def run_batch(
    ...
    *,
    ...
    if not configs:
        return []
    if executor is None:
        from quant_platform.packages.application.is_harness import (
