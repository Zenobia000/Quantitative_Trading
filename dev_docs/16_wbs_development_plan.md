...
| 3.0 資料層 | 120h | 76h | 63% | M1 完成；**FinLab 主源落地（`finlab_source.py`：批次 wide→FinMind-parity parquet + survivorship-clean universe builder，ADR-006 realized；FinMind fallback）+ `research/finlab_universe.py`（②）**；Live feed 待寫 |
