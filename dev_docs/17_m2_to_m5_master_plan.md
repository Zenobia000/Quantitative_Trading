...
| **雙引擎** | zipline-reloaded（event 引擎，台股日曆 + 微結構規則）+ vectorbt（向量網格）；研究迴圈主力為離線 close-to-close sim + 橫斷面 panel runner | [ADR-013](./adrs/ADR-013-mainframe-zipline-reloaded-supersedes-tquant-lab.md)/[ADR-014](./adrs/ADR-014-zipline-reloaded-3-1-1-upgrade-reverses-adr-013-constraints.md)/[ADR-007](./adrs/ADR-007-dual-engine-zipline-vectorbt.md) |
