...
from backtest_platform.research.evaluation.profiles import EvaluationProfile
from backtest_platform.research.evaluation.scorecards import build_scorecards
...
def _headline(bundle: RunBundle, returns: pd.Series) -> dict[str, Any]:
    from backtest_platform.validation import metrics as vmetrics
    m = bundle.metrics
    ex = bundle.extras
    r = returns
    out = {
