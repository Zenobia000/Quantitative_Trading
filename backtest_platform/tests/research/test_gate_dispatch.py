...
from backtest_platform.research import runners as _runners  # noqa: F401 — register built-ins
...
def test_run_and_judge_raises_when_strategy_declares_no_gate(clean_registry):
    ...
    from backtest_platform.strategies.protocol import StrategyRun, register_strategy
